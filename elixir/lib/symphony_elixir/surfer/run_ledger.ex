  ...
  defp upsert_run_conn(conn, %RunRequest{} = request, opts) do
    ...
    execute(
      ...
      [
        ...
        route_value(request, :repository) |> redacted_optional(),
        actor_id |> redacted_optional(),
        actor_id |> redacted_optional(),
        (request.source[:natural_event_key] || request.source[:raw_event_id]) |> redacted_optional(),
        request.lineage.linear[:issue_id] |> redacted_optional(),
        request.lineage.linear[:agent_session_id] |> redacted_optional(),
        request.lineage.discord[:channel_id] |> redacted_optional(),
        request.lineage.discord[:message_id] |> redacted_optional(),
